...
namespace Native.App.Export
{
	...
	{	
		...
		{	
			return "9,me.cqp.luohuaming.CustomGacha";	
		}	
		...
		{	
			...
			Type appDataType = typeof (AppData);	
			// 注册一个 CQApi 实例	
			AppInfo appInfo = new AppInfo ("me.cqp.luohuaming.CustomGacha", 1, 9, "水银自定义抽卡", "1.0.0", 1, "落花茗", "自动样式补全", authCode);	
			...
			AppData.UnityContainer.RegisterInstance<CQLog> ("me.cqp.luohuaming.CustomGacha", AppData.CQLog);	
