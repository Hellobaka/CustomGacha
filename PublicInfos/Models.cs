...
namespace PublicInfos
{
    ...
    public class ItemDrawConfig
    {
        ...
        [Category("核心图片绘制尺寸")] public int ImageHeight { get; set; }
        ...
        [Category("背景图片绘制尺寸")] public int BackgroundImageHeight { get; set; }
        ...
        [Category("核心图片相对于背景的偏移")] public int ImagePointY { get; set; }
    }
    ...
    public class PoolDrawConfig
    {
        ...
        [Category("起始坐标")] public int StartPointY { get; set; }
    ...
    public class GachaItem
    {
        ...
        [Category("数值")] public double UpProbablity { get; set; } = 0;
